...
router.get('/overview/:academicYear?', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const academicYear = req.params.academicYear || '2024-25';
        const prisma = database_1.default.getInstance();
        // Get basic counts
        const [totalStudents, totalTeachers, totalCourses, totalSections, totalDepartments, totalAttendanceSessions] = yield Promise.all([
        ...
        const theoryMarks = yield prisma.theoryMarks.findMany();
        const labMarks = yield prisma.labMarks.findMany();
        let totalScore = 0;
        let markCount = 0;
        ...
        theoryMarks.forEach(marks => {
            ...
            markCount++;
            if (totalMarks >= 30)
                passedStudents++; // Adjusted pass threshold based on actual data scale
        });
        // Process lab marks
        labMarks.forEach(marks => {
            ...
            markCount++;
            if (totalMarks >= 30)
                passedStudents++; // Adjusted pass threshold
        });
...
router.get('/attendance/:academicYear?', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const academicYear = req.params.academicYear || '2024-25';
        const prisma = database_1.default.getInstance();
        ...
        const departmentAnalytics = yield Promise.all(departments.map((dept) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const sectionAnalytics = yield Promise.all(dept.sections.map((section) => __awaiter(void 0, void 0, void 0, function* () {
                let sectionTotalRecords = 0;
                let sectionPresentRecords = 0;
                // Get actual courses for this section with real attendance data
                const actualCourses = yield Promise.all(section.course_offerings.map((offering) => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    return {
                        ...
                        students: yield Promise.all(offering.enrollments.map((enrollment) => __awaiter(void 0, void 0, void 0, function* () {
                            var _a;
                            if (!enrollment.student)
                                return null;
                            // Calculate individual student attendance for this course
                            const studentAttendanceRecords = yield prisma.attendanceRecord.findMany({
                                where: {
                            ...
                            return {
                                ...
                                name: (_a = enrollment.student.user) === null || _a === void 0 ? void 0 : _a.name,
                ...
                section.course_offerings.forEach(offering => {
                    offering.enrollments.forEach(enrollment => {
                        var _a;
                        if ((_a = enrollment.student) === null || _a === void 0 ? void 0 : _a.id) {
...
router.get('/marks/:academicYear?', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const academicYear = req.params.academicYear || '2024-25';
        const prisma = database_1.default.getInstance();
        // Get departments with their sections, students, and actual course offerings
            ...
            const sectionAnalytics = yield Promise.all(dept.sections.map((section) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const actualCourses = yield Promise.all(section.course_offerings.map((offering) => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    theoryMarks.forEach(mark => {
                        ...
                        courseMarkCount++;
                        if (theoryTotal >= 30)
                            coursePassed++; // Adjusted pass threshold
                    });
                    // Process lab marks
...
router.get('/academic-years', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const prisma = database_1.default.getInstance();
