...
router.get('/college/:collegeId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const prisma = database_1.default.getInstance();
...
router.get('/:id/stats', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const courseStats = yield prisma.course.groupBy({
            by: ['type'],
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingDept = yield prisma.department.findFirst({
        ...
        // Find the college
        const collegeRecord = yield prisma.college.findFirst({
            where: { code: college }
        });
        if (!collegeRecord) {
            return res.status(404).json({
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingDept = yield prisma.department.findUnique({
            where: { id }
        });
        if (!existingDept) {
            return res.status(404).json({
        ...
        const codeConflict = yield prisma.department.findFirst({
            where: {
        ...
        if (sections && Array.isArray(sections)) {
            ...
            if (sections.length > 0) {
                ...
                yield prisma.sections.createMany({
                    data: sectionData
                });
            }
        }
...
router.delete('/:id/force', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (const group of existingDepartment.departmentElectiveGroups) {
            ...
            yield prisma.departmentElectiveGroup.delete({
                where: { id: group.id }
            });
        }
        // Delete sections
