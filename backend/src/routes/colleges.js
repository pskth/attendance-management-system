...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const colleges = yield prisma.college.findMany({
            orderBy: { name: 'asc' },
            include: {
                departments: {
                    include: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingCollege = yield prisma.college.findUnique({
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (code && code.toUpperCase() !== existingCollege.code) {
            const codeExists = yield prisma.college.findUnique({
                where: { code: code.toUpperCase() }
            });
            if (codeExists) {
                res.status(409).json({
        ...
        const college = yield prisma.college.update({
            where: { id },
            data: updateData
        });
        res.json({
