...
function getAnalyticsDataForExport(filters) {
            ...
            for (const section of dept.sections) {
                ...
                for (const offering of section.course_offerings) {
                    ...
                    for (const enrollment of offering.enrollments) {
                        ...
                        exportData.detailedStudentData.push(Object.assign(Object.assign({}, studentData), { department: dept.name, departmentCode: dept.code || 'N/A', section: section.section_name }));
                    }
                }
...
function convertToCSV(data) {
    ...
    const rows = data.map(row => Object.values(row).map(value => typeof value === 'string' && value.includes(',') ? `"${value}"` : value).join(',')).join('\n');
    return `${headers}\n${rows}`;
}
...
// Export as CSV
router.get('/csv', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filters = {
            academicYear: req.query.academicYear
        };
        const data = yield getAnalyticsDataForExport(filters);
...
router.get('/excel', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filters = {
            academicYear: req.query.academicYear
        };
...
router.get('/pdf', auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filters = {
            academicYear: req.query.academicYear
        };
